...
import com.example.hubtv.databinding.TraditionalRvBinding
import com.example.hubtv.remote.ModelClass.Data

class TraditionalRVAdapter(
    private val context: Context,
    private val onItemClicked: (Data?) -> Unit
) : ListAdapter<Data, TraditionalRVAdapter.ListViewHolder>(DiffUtil()) {

    class ListViewHolder(itemView: TraditionalRvBinding) :
        RecyclerView.ViewHolder(itemView.root) {

        private val image: ImageView = itemView.traditionalImageView
