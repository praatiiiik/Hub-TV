...
import com.example.hubtv.databinding.FeaturedrvBinding
import com.example.hubtv.remote.ModelClass.Data

class FeaturedRVAdapter (private val context: Context,
private val onItemClicked: (Data?) -> Unit
): ListAdapter<Data, FeaturedRVAdapter.ListViewHolder>(DiffUtil()) {

    class ListViewHolder(itemView: FeaturedrvBinding) :
        RecyclerView.ViewHolder(itemView.root) {

        private val image: ImageView = itemView.featuredImageView
